/* ============================================================
   محرّك الديوانية — Engine Core (v4.5)
...
/* الدالّة الرئيسية: تأخذ نص المحتوى وترجّع تقرير الديوانية كامل */
function generate(text){
  ...
  if(clean.length < 3){
    return {
      insufficient: true,
      message: "اكتب محتوى أوضح عشان الديوانية تقدر تتشاور — كلمة أو كلمتين ما تكفي.",
