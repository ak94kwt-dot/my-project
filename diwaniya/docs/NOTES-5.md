...
- ⏳ **معلّق:** تغيير الاسم فعلياً بالموقع/الكود من «الديوانية» → «ناقشنا» (بانتظار قول المالك «غيّره»). + تأكيد علامة تجارية رسمي (وزارة التجارة + GCC) — خارج نطاقي.
...
3. 🏷️ تغيير الاسم لـ«ناقشنا» (عند «غيّره»).
